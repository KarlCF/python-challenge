...
print ('need to use a card reader?', pagamento_pedido1_cartao and pagamento_pedido2_cartao)
...
print ('need to use a card reader?', pagamento_pedido1_cartao or pagamento_pedido2_cartao)
...
pagamento_pedido3_cartao = False

print ('can the card reader stay?', not pagamento_pedido3_cartao)
